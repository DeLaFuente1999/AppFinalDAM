...
if __name__ == '__main__':
    ...
    while True:             
        ...
        if callable(event):
            ...
            window.close()
            subprocess.Popen(['python', os.path.join(absolutepath, '..\\..\\MENUS\\menuClientes.py')], stdout=subprocess.PIPE, stderr=subprocess.PIPE, stdin=subprocess.PIPE, shell=True)
